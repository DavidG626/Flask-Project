...
app.register_blueprint(lab_route_bp, url_prefix='/labs')
app.register_blueprint(imaging_routes_bp, url_prefix='/imaging')
app.register_blueprint(operative_routes_bp, url_prefix='/operative')
app.register_blueprint(auth_routes_bp, url_prefix='/auth')
app.register_blueprint(misc_routes_bp, url_prefix='/misc')
