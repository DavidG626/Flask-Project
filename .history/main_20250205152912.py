...
from routes.lab_route import lab_route_bp
from routes.imaging_routes import imaging_routes_bp
from routes.operative_routes import operative_routes_bp
from routes.auth_routes import auth_routes_bp
from routes.misc_routes import misc_routes_bp
