...
class Patient(db.Model):
   ...
   medical_conditions = db.relationship('MedicalConditions', backref='patient', cascade='all, delete-orphan')
...
class MedicalCondition(db.Model):
   ...
   medical_condition_name = db.Column(db.String(50), nullable=False)
