...
class Patient(db.Model):
   ...
   authorizations = db.relationship('Auth', backref='patient', lazy=True)
   ...
   class Patient(db.Model):
    ...
    authorizations = db.relationship('Auth', backref='patient', cascade='all, delete-orphan')  # Add this line
