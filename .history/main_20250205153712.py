...
from routes.lab_route import labs_bp
...
app.register_blueprint(labs_bp, url_prefix='/labs')                 # Changed from lab_route_bp
app.register_blueprint(imaging_bp, url_prefix='/imaging')           # Changed from imaging_routes_bp
app.register_blueprint(operative_bp, url_prefix='/operative')       # Changed from operative_routes_bp
app.register_blueprint(auth_bp, url_prefix='/auth')                # Changed from auth_routes_bp
app.register_blueprint(misc_bp, url_prefix='/misc')                # Changed from misc_routes_bp
