...
from models.wc_patient_models import Patient, BodyPart, Employer, ClaimsAdmin, Lawyer, Allergy, PastMedicalHistory, MedicalCondition  # Add PastMedicalHistory here
