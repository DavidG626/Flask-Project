...
def upload_lab(patient_id):
    ...
    if request.method == 'POST':
        ...
        if file and file.filename.endswith('.pdf'):
            ...
            return redirect(url_for('dashboard.view_lab', patient_id=patient_id))
...
def upload_imaging(patient_id):
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            upload_folder = os.path.join('uploads', 'imaging', str(patient_id))
...
def view_imaging(imaging_id):
    ...
    # You can use send_file to display the PDF
    return send_file(imaging_result.file_path, mimetype='application/pdf')
...
@dashboard_bp.route('/download_operative_report/<int:report_id>')
@login_required
@check_session_timeout
def download_operative_report(report_id):
    """
    Download a specific operative report
    """
