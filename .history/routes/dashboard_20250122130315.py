...
def update_patient(patient_id):
    ...
    if request.method == 'POST':
        try:
            ...
            patient.patient_date_of_birth = request.form.get('patient_date_of_birth')
...
def update_medical_history(patient_id):
    ...
    if request.method == 'POST':
        try:
            ...
            medical_history.no_medical_history = 'no_medical_history' in request.form
            medical_history.allergies = 'allergies' in request.form
            medical_history.anemia = 'anemia' in request.form
            medical_history.anxiety = 'anxiety' in request.form
            medical_history.arthritis = 'arthritis' in request.form
            medical_history.asthma = 'asthma' in request.form
            medical_history.blood_transfusion = 'blood_transfusion' in request.form
            medical_history.cancer = 'cancer' in request.form
            medical_history.congestive_heart_failure = 'congestive_heart_failure' in request.form
            medical_history.nerve_muscle_disease = 'nerve_muscle_disease' in request.form
            medical_history.lung_disease = 'lung_disease' in request.form
            medical_history.meningitis = 'meningitis' in request.form
            medical_history.depression = 'depression' in request.form
            medical_history.hiv_aids = 'hiv_aids' in request.form
            medical_history.kidney_disease = 'kidney_disease' in request.form
            medical_history.diabetes = 'diabetes' in request.form
            medical_history.clotting_disorder = 'clotting_disorder' in request.form
            medical_history.high_blood_pressure = 'high_blood_pressure' in request.form
            medical_history.acid_reflux = 'acid_reflux' in request.form
            medical_history.glaucoma = 'glaucoma' in request.form
            medical_history.gout = 'gout' in request.form
            medical_history.heart_attack = 'heart_attack' in request.form
            medical_history.other_medical = request.form.get('other_medical')

            # Update surgical history
            medical_history.never_had_surgery = 'never_had_surgery' in request.form
            medical_history.appendix = 'appendix' in request.form
            medical_history.brain_surgery = 'brain_surgery' in request.form
            medical_history.breast_surgery = 'breast_surgery' in request.form
            medical_history.heart_bypass = 'heart_bypass' in request.form
            medical_history.orthopedic_surgery = request.form.get('orthopedic_surgery')
            medical_history.other_surgery = request.form.get('other_surgery')
    ...
    return render_template('pmh.html', patient=patient)
