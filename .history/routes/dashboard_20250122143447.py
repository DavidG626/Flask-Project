...
from models.wc_patient_models import Patient, BodyPart, Employer, ClaimsAdmin, Lawyer, PastMedicalHistory, Allergy, MedicalCondition, Surgeryfrom forms.wc_patient_portal_form import wc_PatientRegistrationForm
