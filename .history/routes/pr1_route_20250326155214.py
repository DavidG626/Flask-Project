...
@pr1_bp.route('/patient/<int:patient_id>/pr1_rfas')
@login_required
@check_session_timeout
def patient_pr1_rfas(patient_id):
    patient = Patient.query.get_or_404(patient_id)
    ...
    rfas = PR1Authorization.query.filter_by(patient_id=patient_id).order_by(PR1Authorization.created_at.desc()).all()
    
    return render_template('patient_pr1_rfas.html', patient=patient, rfas=rfas)
