...
from models.patient_medical_hx_models import Allergy, PastMedicalHistory, MedicalCondition, Surgery, Medicationfrom forms.wc_patient_portal_form import wc_PatientRegistrationForm
