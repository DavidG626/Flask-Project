...
from models.icd10_models import ICD10Code, PatientDiagnosis 
...
def create_progress_note(patient_id):
    ...
    # Get patient's diagnoses with ICD10 information
    patient_diagnoses = db.session.query(ICD10Code)\
        .join(PatientDiagnosis)\
        .filter(PatientDiagnosis.patient_id == patient_id)\
        .all()
