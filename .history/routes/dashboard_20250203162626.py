...
# Upload Auth
@dashboard_bp.route('/upload_auth/<int:auth_id>', methods=['GET', 'POST'])
@login_required
@check_session_timeout
def upload_auth(auth_id):
    patient = Patient.query.get_or_404(auth_id)
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            return redirect(url_for('dashboard.authorization', patient_id=patient_id))
