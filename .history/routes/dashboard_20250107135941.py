...
from models.provider_info_models import ProviderInfo
...
@dashboard.route('/update_info', methods=['GET', 'POST'])
@login_required
def update_info():
    """
...
# You might want to add these routes later based on your sidebar links:
# @dashboard.route('/office_schedule')
# @dashboard.route('/or_schedule')
# @dashboard.route('/billing')
# @dashboard.route('/cpt')
# @dashboard.route('/icd10')