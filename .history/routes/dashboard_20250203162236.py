...
# Start of Auths
@dashboard_bp.route('/patient/<int:patient_id>/authorization')
@login_required
@check_session_timeout
def authoriztion(patient_id):
...
# Upload Auth
@dashboard_bp.route('/upload_auth/<int:patient_id>', methods=['GET', 'POST'])
@login_required
@check_session_timeout
...
@dashboard_bp.route('/view_auth/<int:patient_id>')
@login_required
@check_session_timeout
def view_auth(patient_id):

    #display a specific operative result
    auth = Auth.query.get_or_404(patient_id) 
