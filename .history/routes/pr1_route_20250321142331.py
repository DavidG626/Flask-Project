...
def view_pr1(pr1_id):
    ...
    narrative_report = NarrativeReport.query.filter_by(pr1_id=pr1_id).first()
    
    # Get diagnoses if needed
    diagnoses = [] 
    if pr1_report.diagnoses:  # Assuming this field contains ICD10 codes or references
        # Logic to fetch diagnoses
        pass
