...
def patient_misc(patient_id):  # Changed to match template url_for
    ...
    if (patient.provider_first_name != current_user.first_name or 
        ...
        return redirect(url_for('misc.my_patients'))
...
def upload_misc(patient_id):
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            return redirect(url_for('misc.patient_misc', patient_id=patient_id))
...
def delete_misc(misc_id):
    ...
    return redirect(url_for('misc.patient_misc', patient_id=patient.id))
