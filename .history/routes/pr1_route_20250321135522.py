...
def view_pr1(pr1_id):
    ...
    return render_template('view_pr1.html', pr1_report=pr1_report, patient=patient)
...
def view_pr1(pr1_id):
    ...
    return render_template('view_pr1.html', pr1_report=pr1_report, patient=patient, provider=current_user)
