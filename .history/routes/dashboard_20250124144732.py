        ...
        if request.method == 'POST':
            ...
            try:
                ...
                if not patient.medical_history:
                    ...
                    print(f"Created medical history with ID: {medical_history.id}")
                else:
                    print("Using existing medical history")
                    medical_history = patient.medical_history
                    print(f"Existing medical history ID: {medical_history.id}")
                ...
                for i in range(1, 16):
                    ...
                    if allergy_name and allergy_name.strip():
                        ...
                        try:
                            ...
                            print(f"Added allergy successfully")
                        except Exception as e:
                            print(f"Error adding allergy: {str(e)}")
                            raise
...
def update_medical_history(patient_id):
    ...
    if request.method == 'POST':
        try:
            ...
            for i in range(1, 11):  # For 10 possible condition fields
            ...
            # Add new surgeries
            for i in range(1, 11):  # For 10 possible surgery fields
            ...
            # Add new medications
            for i in range(1, 11):  # For 10 possible medication fields
            ...
            print("Allergies:", [a.allergy_name for a in medical_history.allergies])
            print("Conditions:", [c.condition_name for c in medical_history.medical_conditions])
            print("Medications:", [m.medication_name for m in medical_history.medications])
            ...
            db.session.rollback()
            print("Error saving medical history:", str(e))  # Debug print
            flash('An error occurred while updating medical history.', 'error')
            return redirect(url_for('dashboard.patient_detail', patient_id=patient_id))
