...
def patient_operative_reports(patient_id):
    ...
    if (patient.provider_first_name != current_user.first_name or 
        ...
        return redirect(url_for('operative.my_patients'))
...
def upload_operative_report(patient_id):
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            return redirect(url_for('operative.patient_operative_reports', patient_id=patient_id))
...
def delete_operative_report(report_id):
    ...
    return redirect(url_for('operative.patient_operative_reports', patient_id=patient.id))
