...
from models.wc_patient_models import Patient, MedicalCondition, Employer, ClaimsAdmin, Lawyer, PatientDiagnosis
    ...
    if form.validate_on_submit():
        try:
            ...
            for condition in medical_condition:
                if condition:  # Only add if body part was entered
                    medical_condition = MedicalCondition(
                        patient_id=patient.id,
                        medical_condition_name=condition
                    )
