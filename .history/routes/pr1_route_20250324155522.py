...
def view_pr1_rfa(rfa_id):
    ...
    return render_template('view_rfa.html',  # Use the existing RFA template
                          rfa=rfa, 
                          patient=patient, 
                          progress_note=pr1_report,  # Pass the PR1 report as progress_note
                          rfa_items=rfa_items)
