...
def update_medical_history(patient_id):
    ...
    # Get patient's existing diagnoses and available ICD10 codes
    ...
    return render_template('update_medical_hx.html', patient=patient, icd10_codes=ICD10Code.query.order_by(ICD10Code.description).all())
