...
def patient_imaging(patient_id):
    ...
    if (patient.provider_first_name != current_user.first_name or 
        ...
        return redirect(url_for('imaging.my_patients'))
...
def upload_imaging(patient_id):
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            return redirect(url_for('imaging.patient_imaging', patient_id=patient_id))
...
def delete_imaging(imaging_id):
    ...
    return redirect(url_for('imaging.patient_imaging', patient_id=patient.id))
