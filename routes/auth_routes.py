...
def patient_authorizations(patient_id):
    ...
    if (patient.provider_first_name != current_user.first_name or 
        ...
        return redirect(url_for('auth.my_patients'))
...
def upload_auth(patient_id):  # Changed from auth_id
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            return redirect(url_for('auth.patient_authorizations', patient_id=patient_id))    
...
def delete_auth(auth_id):
    ...
    return redirect(url_for('auth.patient_authorizations', patient_id=patient.id))
