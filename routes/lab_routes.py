...
def patient_labs(patient_id):
    ...
    if (patient.provider_first_name != current_user.first_name or 
        ...
        return redirect(url_for('labs.my_patients'))
...
def upload_lab(patient_id):
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            return redirect(url_for('labs.patient_labs', patient_id=patient_id))
...
def delete_lab(lab_id):
    ...
    return redirect(url_for('labs.patient_labs', patient_id=patient.id))
