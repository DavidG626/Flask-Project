...
class AllergyForm(FlaskForm):
    ...
    StringField('Allergy Name', validators=[DataRequired()])
    allergy_severity = StringField('Allergy Severity', validators=[Optional()])
    reaction = StringField('Reaction', validators=[Optional()])
